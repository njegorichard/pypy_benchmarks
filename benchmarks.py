...
#CPython Python benchmarks
_register_new_bm('py3_json_dump_v2', 'py3_json_dump_v2', globals())
_register_new_bm('py3_django_v2', 'py3_django_v2',globals(), bm_env={'PYTHONPATH': relative('lib/django-1.5')})
_register_new_bm('py3_json_load', 'py3_json_load',globals(), extra_args=['json_load'])
_register_new_bm('py3_spectral_norm', 'py3_spectral_norm',globals())
_register_new_bm('py3_hexiom2', 'py3_hexiom2',globals())
_register_new_bm('py3_raytrace', 'py3_raytrace', globals())
_register_new_bm('py3_telco', 'py3_telco',globals())
_register_new_bm('py3_meteor_contest', 'py3_meteor_contest',globals())
_register_new_bm('py3_regex_compile', 'py3_regex_compile',globals())
_register_new_bm('py3_regex_effbot', 'py3_regex_effbot',globals())
_register_new_bm('py3_regex_v8', 'py3_regex_v8',globals())
_register_new_bm('py3_richards', 'py3_richards',globals())
_register_new_bm('py3_chaos', 'py3_chaos',globals())
_register_new_bm('py3_fannkuch', 'py3_fannkuch',globals())
_register_new_bm('py3_float', 'py3_float',globals())
_register_new_bm('py3_go', 'py3_go',globals())
_register_new_bm('py3_nbody', 'py3_nbody',globals())
_register_new_bm('py3_nqueens', 'py3_nqueens',globals())
_register_new_bm('py3_pidigits', 'py3_pidigits',globals())
